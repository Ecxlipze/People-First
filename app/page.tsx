...
export default function Landing() {
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-[radial-gradient(ellipse_at_center_top,#2a2a30_0%,#141417_45%,#0b0b0d_100%)]">
      <main className="relative flex flex-1 flex-col items-center justify-center px-4">
        <RadialNav />

        <div className="animate-fade-in-up relative mt-16 flex flex-col items-center">
          ...
          <Image
            ...
            height={505}
            priority
            className="animate-floaty w-[210px] max-w-[85vw] sm:w-[300px] lg:w-[480px]"
          />
        </div>
      </main>

      <footer className="animate-fade-in-up flex flex-col gap-6 px-6 pb-8 text-sm text-zinc-400 sm:flex-row sm:items-end sm:justify-between sm:px-14">
        ...
        <ContactTrigger
          href="/contact"
          className="group inline-flex items-center gap-3 self-start text-lg font-bold text-white transition-colors hover:text-accent sm:self-auto sm:text-xl"
        >
          Say Hello!
