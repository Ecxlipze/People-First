...
if DB_ENGINE == "sqlite3":
    ...
    DATABASES = {
        "default": {
            ...
            # No default: a guessable fallback password means a misconfigured
            # environment quietly tries to authenticate instead of failing.
            # The key must be present, but may be empty — that is legitimate
            # for a Postgres using trust or peer authentication.
