  ...
  return (
    ...
    >
      ...
      <Image
        ...
        width={392}
        height={353}
        className="animate-floaty absolute left-6 top-48 hidden w-20 select-none sm:left-8 sm:top-52 sm:w-24 xl:block"
      />
      ...
      <Image
        ...
        className="animate-floaty absolute right-12 top-12 hidden w-20 select-none sm:right-24 sm:top-16 sm:w-28 xl:block"
      />
    </div>
  );
}
...
export default function StoryShowcase() {
  ...
  return (
    <div className="pf-blend relative z-[60] overflow-clip rounded-t-[2rem] bg-white shadow-[0_-24px_60px_-20px_rgba(80,80,120,0.35)] max-md:-mt-16 sm:rounded-t-[3rem] md:-mt-[100vh]">
      <div className="pf-seam relative flex items-center py-10 sm:py-12 md:min-h-screen">
        ...
        >
          ...
          <div className="max-w-xl">
            <h2 className="max-xl:!opacity-100 text-[2rem] font-bold leading-none tracking-tight text-black sm:text-[2.25rem]">
              The Story
            </h2>
            <p className="max-xl:!opacity-100 mt-2 text-lg font-semibold text-black sm:text-xl">
              Every Movement Begins with a Question.
            </p>

            {/* the founding question, as a quote bubble */}
            <div className="max-xl:!opacity-100 relative mt-8">
            ...
            <p className="max-xl:!opacity-100 mt-6 max-w-[500px] text-[15px] leading-relaxed text-black sm:text-base">
            ...
            <p className="max-xl:!opacity-100 mt-16 text-lg text-black sm:text-xl">
          ...
          >
            ...
            <div className="relative z-10 -mt-12 flex min-h-[17rem] w-full flex-col items-center justify-center rounded-[2rem] bg-[linear-gradient(180deg,#3979a5_0%,#4fa0af_100%)] p-[4px] text-center shadow-[0_18px_44px_-16px_rgba(30,20,80,0.4)] sm:absolute sm:-bottom-12 sm:left-1/2 sm:mt-0 sm:aspect-square sm:min-h-0 sm:w-[75%] sm:-translate-x-1/2 sm:rounded-full">
              ...
              <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-[calc(2rem-4px)] bg-[#f6f6f6] px-5 py-6 sm:justify-start sm:rounded-full sm:px-[12%] sm:pb-0 sm:pt-[8%]">
              ...
              <span className="flex aspect-square w-[29%] min-w-14 flex-none items-center justify-center rounded-full bg-[linear-gradient(135deg,#0286a4_0%,#035688_100%)]">
                <Image
