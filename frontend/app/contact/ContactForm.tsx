...
import { DEFAULT_INQUIRY_TYPE, ROLES, type InquiryType } from "./inquiry";
...
export default function ContactForm({
  ...
  /* Preselects "I am a" — e.g. the /partner CTA opens the modal on
     "Training Partner". */
  defaultRole?: string;
  /* Which Inquiry.inquiry_type the submission is filed under. Set by the route
     rendering the form; re-validated server-side because it ships as a hidden
     field. */
